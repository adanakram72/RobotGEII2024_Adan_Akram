...
namespace WpfAsservissementDisplay
{
    ...
    public partial class AsservissementRobot2RouesDisplayControl : UserControl
    {
        ...
        public void UpdatePolarConsigneValues(double consigneX, double consigneTheta)
        {
            consigneXList.Enqueue(consigneX);
            consigneThetaList.Enqueue(consigneTheta);
        }
        public void UpdateIndependantConsigneValues(double consigneM1, double consigneM2)
        {
            consigneM1List.Enqueue(consigneM1);
            consigneM2List.Enqueue(consigneM2);  
        }

        public void UpdatePolarCommandValues(double commandX,  double commandTheta)
        {
        ...
        public void UpdatePolarOdometry(double valueX, double valueTheta)
        {
            measuredXList.Enqueue(valueX);
            measuredThetaList.Enqueue(valueTheta);
        }
        public void UpdateIndependantOdometry(double valueM1, double valueM2)
        {
            measuredM1List.Enqueue(valueM1);
            measuredM2List.Enqueue(valueM2);
        }

        public void UpdatePolarErrorValues(double errorX, double errorTheta)
        {
            errorXList.Enqueue(errorX);
            errorThetaList.Enqueue(errorTheta);
        }
        public void UpdateIndependantErrorValues(double errorM1, double errorM2)
        {
            errorM1List.Enqueue(errorM1);
            errorM2List.Enqueue(errorM2);
        }

        public void UpdatePolarCorrectionValues(double corrPX, double corrPTheta, double corrIX, double corrITheta, double corrDX, double corrDTheta)
        {
        ...
        public void UpdateIndependantCorrectionValues(double corrPM1, double corrPM2, double corrIM1, double corrIM2, double corrDM1, double corrDM2)
        {
            if (isDisplayActivated)
            {
        ...
        public void UpdatePolarCorrectionGains(double KpX, double KpTheta, double KiX,  double KiTheta, double KdX, double KdTheta)
        {
            this.KpX = KpX;
        ...
        public void UpdateIndependantCorrectionGains(double KpM1, double KpM2, double KiM1, double KiM2, double KdM1, double KdM2)
        {
            this.KpM1 = KpM1;
            this.KpM2 = KpM2;
        ...
        public void UpdatePolarCorrectionLimits(double corrLimitPX, double corrLimitPTheta, double corrLimitIX, double corrLimitITheta, double corrLimitDX, double corrLimitDTheta)
        {
        ...
        public void UpdateIndependantCorrectionLimits(double corrLimitPM1, double corrLimitPM2, double corrLimitIM1, double corrLimitIM2,double corrLimitDM1, double corrLimitDM2)
        {
